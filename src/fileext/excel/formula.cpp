...
void Formula::evaluateFormula(Name& name, int nameIndex, int level) {
    try {
        ...
        const std::vector<char>& sztab = SZDICT.at(m_book->m_biffVersion);
